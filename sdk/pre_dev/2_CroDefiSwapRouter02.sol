...
CroDefiSwapRouter02 --> 0xCeB90E4C17d626BE0fACd78b79c9c87d7ca181b3 
--> farm.c4ei.net  Router --> 

https://etherscan.io/address/0xCeB90E4C17d626BE0fACd78b79c9c87d7ca181b3#code
...
Contract Name: CroDefiSwapRouter02
...
library CroDefiSwapLibrary {
    ...
    function pairFor(address factory, address tokenA, address tokenB) internal pure returns (address pair) {
        ...
        pair = address(uint(keccak256(abi.encodePacked(
                ...
                hex'f9c5e83424f2294341bfe3c4b0c0a435fbc1f4a4826d436ef211e419527c6ce2' // init code hash
            ))));
    }
